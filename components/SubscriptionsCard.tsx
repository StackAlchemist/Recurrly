...
const SubscriptionsCard = ({ name, price, currency, icon, billing, color, category, plan, renewalDate, paymentMethod, expanded, onPress, startDate, status}: SubscriptionCardProps) => {
  return (
